...
To-Do:
Put cubes on the position of each joint
...
Imagine: 
    ...
    Then given a rotation on this connection, what will happen?
...
def set_cube_animation(joints, rotations, root_position, parents, frametime):
    global_position = np.zeros((rotations.shape[0], rotations.shape[1], 3)) # represent the position for all joints in t frames
